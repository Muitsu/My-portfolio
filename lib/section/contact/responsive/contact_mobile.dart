...
class ContactMobile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double descSpace = 20;
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: mobileHorizontalPadding),
        ...
        children: [
          Column(
            ...
            children: [
              ...
              const MiniTitle(text: 'My thought', fontSize: 20),
              SizedBox(height: titleSpace),
              const TextTitle(text: 'Coding is my passion !', fontSize: 25),
              SizedBox(height: titleSpace),
              const Text(
                style: TextStyle(
                  color: Colors.white,
